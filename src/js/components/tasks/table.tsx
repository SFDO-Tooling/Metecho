              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourTaskStatusColumn">
                    ...
                    Tester’s review. If the Developer retrieves new changes, the
                    status moves back to <b>In Progress</b>. Once the Task is
                    added to the Project on GitHub, the status is{' '}
                    <b>Complete</b>.
                  </Trans>
                }
              />
              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourTaskDeveloperColumn">
                    A <b>Developer</b> is the person assigned to do the work of
                    a Task. Developers create Dev Orgs for their work, retrieve
                    their changes, and then submit their work for someone to
                    test. Anyone with permission to contribute to the Project on
                    GitHub can be assigned as a Developer on a Task.
                  </Trans>
                }
              />
            </>
              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourTaskTesterColumn">
                    ...
                    <b>Test</b>, it is ready for testing. Testers create a Test
                    Org to view the Developer’s work, and approve the work or
                    request changes before the Task can be completed.
                  </Trans>
                }
              />
            </div>
