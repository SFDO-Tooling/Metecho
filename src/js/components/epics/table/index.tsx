              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourEpicNameColumn">
                    ...
                    GitHub, select the branch link. A “branch” is a way to
                    create a new feature or make a modification to existing
                    software, without impacting the main “trunk” of the Project.
                  </Trans>
                }
              />
            </>
              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourEpicStatusColumn">
                    ...
                    status changes to <b>Merged</b> when the Epic branch has
              ...
              <TourPopover
                ...
                body={
                  <Trans i18nKey="tourEpicCollaboratorsColumn">
                    The Collaborators column shows the number of people working
                    on the Epic. Anyone with permission to view the Project on
                    GitHub can be assigned as an Epic Collaborator.
                  </Trans>
                }
              />
            </>
