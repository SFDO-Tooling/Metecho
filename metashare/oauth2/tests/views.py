...
class TestLoggingOAuth2LoginView:
    def test_dispatch(self, rf, mocker):
        mocker.patch("metashare.oauth2.views.OAuth2LoginView.dispatch")
        logger = mocker.patch("metashare.oauth2.views.logger.info")
        request = rf.get("/")
...
class TestLoggingOAuth2CallbackView:
    def test_dispatch(self, rf, mocker):
        mocker.patch("metashare.oauth2.views.OAuth2CallbackView.dispatch")
        logger = mocker.patch("metashare.oauth2.views.logger.info")
        request = rf.get("/")
