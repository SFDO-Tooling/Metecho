...
def test_project_config():
    with patch("metashare.api.custom_cci_configs.BaseProjectConfig.__init__") as init:
...
def test_global_config():
    with ExitStack() as stack:
        project_init = stack.enter_context(
            patch("metashare.api.custom_cci_configs.BaseProjectConfig.__init__")
        )
        global_init = stack.enter_context(
            patch("metashare.api.custom_cci_configs.BaseGlobalConfig.__init__")
        )
